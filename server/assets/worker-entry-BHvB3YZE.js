...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BbepX_Kt.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-OebqS9je.js").then((n2) => n2.k),
...
var ROUTER_BASEPATH = "rufusakande";
var SERVER_FN_BASE = "/rufusakande/_serverFn/";

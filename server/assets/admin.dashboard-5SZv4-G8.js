import { a0 as requireReact, r as reactExports, P as getDefaultExportFromCjs, a1 as commonjsGlobal, a2 as React, U as jsxRuntimeExports } from "./worker-entry-BHvB3YZE.js";
import { r as reactDomExports, s as supabase, M as Mail } from "./router-OebqS9je.js";
import { A as AdminLayout, B as Briefcase, F as FileText } from "./AdminLayout-ZrbzTygq.js";
import { T as TrendingUp } from "./trending-up-DDprAo16.js";
import { c as clsx } from "./button-wGftFUPd.js";
import "node:events";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./loader-circle-2Tychkij.js";
...
const COLORS = ["var(--primary)", "var(--gold)", "#6B7280", "#94A3B8"];
function AdminDashboardPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardContent, {}) });
}
function DashboardContent() {
  ...
  const [recentMessages, setRecentMessages] = reactExports.useState([]);
  reactExports.useEffect(() => {
    void load();
  }, []);
  async function load() {
    const [pf, bl, ms, msUnread, pfAll, blAll, msAll, recPosts, recProj, recMsg] = await Promise.all([supabase.from("portfolio").select("*", {
      count: "exact",
      head: true
    }).eq("status", "published"), supabase.from("blog_posts").select("*", {
      count: "exact",
      head: true
    }).eq("status", "published"), supabase.from("contact_messages").select("*", {
      count: "exact",
      head: true
    }), supabase.from("contact_messages").select("*", {
      count: "exact",
      head: true
    }).eq("is_read", false), supabase.from("portfolio").select("created_at, category"), supabase.from("blog_posts").select("created_at"), supabase.from("contact_messages").select("created_at"), supabase.from("blog_posts").select("id, title, created_at").order("created_at", {
      ascending: false
    }).limit(5), supabase.from("portfolio").select("id, title, created_at").order("created_at", {
      ascending: false
    }).limit(5), supabase.from("contact_messages").select("id, name, email, created_at").order("created_at", {
      ascending: false
    }).limit(5)]);
    setStats({
      ...
      blog: bl.count ?? 0,
      messages: ms.count ?? 0,
      unreadMessages: msUnread.count ?? 0
    });
    const byMonth = (rows) => {
      const map2 = /* @__PURE__ */ new Map();
      ...
      (rows ?? []).forEach((r) => {
        ...
        if (map2.has(key)) map2.set(key, (map2.get(key) ?? 0) + 1);
      });
      return Array.from(map2, ([month, count]) => ({
        month,
        count
      }));
    };
    const portfolioCatMap = /* @__PURE__ */ new Map();
    (pfAll.data ?? []).forEach((r) => {
      const cat = r.category ?? "Autres";
      portfolioCatMap.set(cat, (portfolioCatMap.get(cat) ?? 0) + 1);
    });
    const weekMap = /* @__PURE__ */ new Map();
    const now = /* @__PURE__ */ new Date();
    for (let i = 5; i >= 0; i--) {
      const d = new Date(now.getTime() - i * 7 * 864e5);
      const key = `S${Math.ceil(d.getDate() / 7)} ${d.toLocaleDateString("fr-FR", {
        month: "short"
      })}`;
      weekMap.set(key, 0);
    }
    (msAll.data ?? []).forEach((r) => {
      const d = new Date(r.created_at);
      const diff = Math.floor((now.getTime() - d.getTime()) / (7 * 864e5));
      if (diff < 6) {
        const key = `S${Math.ceil(d.getDate() / 7)} ${d.toLocaleDateString("fr-FR", {
          month: "short"
        })}`;
    ...
    setCharts({
      postsByMonth: byMonth(blAll.data),
      portfolioByMonth: byMonth(pfAll.data),
      portfolioByCategory: Array.from(portfolioCatMap, ([name, value]) => ({
        name,
        value
      })),
      messagesByWeek: Array.from(weekMap, ([week, count]) => ({
        week,
        count
      }))
    });
    setRecentPosts(recPosts.data ?? []);
    setRecentProjects(recProj.data ?? []);
    setRecentMessages(recMsg.data ?? []);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-3xl text-foreground", children: "Tableau de bord" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Vue d'ensemble de votre activité." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Projets publiés", value: stats?.portfolio ?? 0, icon: Briefcase }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Articles publiés", value: stats?.blog ?? 0, icon: FileText }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Messages reçus", value: stats?.messages ?? 0, icon: Mail }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { label: "Messages non lus", value: stats?.unreadMessages ?? 0, icon: TrendingUp, highlight: stats?.unreadMessages ? true : false })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Articles publiés (6 derniers mois)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: charts?.postsByMonth ?? [], children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Projets ajoutés (6 derniers mois)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: charts?.portfolioByMonth ?? [], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "var(--border)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "month", stroke: "var(--muted-foreground)", fontSize: 12 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "var(--muted-foreground)", fontSize: 12, allowDecimals: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "count", stroke: "var(--gold)", strokeWidth: 3, dot: {
          r: 4
        } })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Répartition portfolio par catégorie", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: charts?.portfolioByCategory ?? [], dataKey: "value", nameKey: "name", outerRadius: 90, label: true, children: (charts?.portfolioByCategory ?? []).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORS[i % COLORS.length] }, i)) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "Messages reçus par semaine", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: charts?.messagesByWeek ?? [], children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "var(--border)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "week", stroke: "var(--muted-foreground)", fontSize: 11 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "var(--muted-foreground)", fontSize: 12, allowDecimals: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: {
          background: "var(--card)",
          border: "1px solid var(--border)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "var(--gold)", radius: [6, 6, 0, 0] })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(RecentList, { title: "Derniers articles", items: recentPosts.map((p) => ({
        id: p.id,
        primary: p.title,
        secondary: fmt(p.created_at)
      })) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(RecentList, { title: "Derniers projets", items: recentProjects.map((p) => ({
        id: p.id,
        primary: p.title,
        secondary: fmt(p.created_at)
      })) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(RecentList, { title: "Derniers messages", items: recentMessages.map((m) => ({
        id: m.id,
        primary: m.name,
        secondary: `${m.email} · ${fmt(m.created_at)}`
      })) })
    ] })
  ] });
}
...
function KpiCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-xl border p-5 shadow-sm ${highlight ? "border-gold bg-gold/10" : "border-border bg-card"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: `h-4 w-4 ${highlight ? "text-gold-dark" : "text-muted-foreground"}` })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 font-serif text-3xl text-foreground", children: value })
  ] });
}
function ChartCard({
  title,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-5 shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 text-sm font-medium text-foreground", children: title }),
    children
  ] });
}
function RecentList({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-5 shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 text-sm font-medium text-foreground", children: title }),
    items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Aucune donnée." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: items.map((it) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "border-b border-border pb-2 last:border-0 last:pb-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "line-clamp-1 text-sm font-medium text-foreground", children: it.primary }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: it.secondary })
    ] }, it.id)) })
  ] });
}
export {
